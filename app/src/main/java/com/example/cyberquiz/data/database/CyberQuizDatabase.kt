...
abstract class CyberQuizDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_5_6 = object : Migration(5, 6) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE review_items ADD COLUMN reviewStage INTEGER NOT NULL DEFAULT 0")
                database.execSQL("ALTER TABLE review_items ADD COLUMN nextReviewAt INTEGER NOT NULL DEFAULT 0")
                database.execSQL("ALTER TABLE review_items ADD COLUMN lastReviewedAt INTEGER NOT NULL DEFAULT 0")
                database.execSQL("ALTER TABLE review_items ADD COLUMN reviewAttempts INTEGER NOT NULL DEFAULT 0")
                database.execSQL("ALTER TABLE review_items ADD COLUMN totalReviewResponseMs INTEGER NOT NULL DEFAULT 0")
            }
        }
